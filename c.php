...
class NameCardPDF extends FPDF
{
    function Header()
    {
        ...
        $this->Cell(0, 15, 'C-DEBUG TEAM NAME CARDS', 0, 1, 'C');
...
// Fetch C-Debug teams
$sql = "SELECT DISTINCT id, team_name FROM c_debug_teams ORDER BY id ASC";
...
foreach ($teams as $index => $teamName) {
    ...
    // Add "C-DEBUG" label at bottom
    $pdf->SetXY($x, $y + 25);
    $pdf->SetFont('Arial', '', 10);
    $pdf->SetTextColor(100, 100, 100);
    $pdf->Cell($cardWidth, 10, 'C-DEBUG', 0, 1, 'C');
...
$pdf->Output('I', 'C_Debug_Name_Cards.pdf');
ob_end_flush();
